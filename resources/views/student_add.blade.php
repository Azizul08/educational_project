            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-contact-left">
                  ...
                  <form class="contactform" method="post" url="('/student-add')" onsubmit="return validate(this);">
                            {{csrf_field()}}                  
                    ...
                    <p class="comment-form-author">
                      <label for="fatherName">Fathers Name <span class="required">*</span></label>
                      <input type="text" required="required" size="30" value="" name="fatherName">
                    </p>
                    <p class="comment-form-author">
                      <label for="fatherName">Student ID <span class="required">*</span></label>
                      <input type="text" required="required" size="30" value="" name="studentId">
                    </p>
