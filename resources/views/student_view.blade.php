            ...
            <div class="row">
              ...
              <div>
                  <div class="mx-auto pull-right">
                      <div class="">
                          <form action="{{ url('/student-view') }}" method="GET" role="search">
                              ...
                              <div class="input-group">
                                  ...
                                  <a href="{{ url('/student-view') }}" class=" mt-1">
              ...
              <br>
              <br>
              <table class="display table table-bordered table-responsive nowrap cusTableStyle" width="100%" cellspacing="0">
                            ...
                            <tbody>
                              ...
                              <tr>
                                            ...
                                            <td>{{$a->subject}}</td>
                                            <td>{{$a->session}}</td>
                                            <td><a href="#" target="_blank" class="btn btn-xs btn-primary "><i class="fa fa-edit"></i> Edit</a>&nbsp;&nbsp;<a href="#" cus="{{$a->id}}" class="btn btn-xs btn-danger button-delete"><i class="fa fa-trash-o"></i> delete</a></td>
                              </tr>
                              @endforeach
                            </tbody>
